...
const ServiceItem = ({
  ...
  return (
    <div className="flex flex-col gap-4 w-[400px] rounded-xl bg-slate-800 shadow-xl p-8 mr-8 mt-8">
      ...
      <Link className="text-gray-100 flex items-center gap-3 mt-2 text-base font-semibold" href="">
...
const OurServices = () => {
  ...
  return (
    <section className="p-24 px-48 flex flex-col gap-12 bg-white w-full mt-[120px]">
